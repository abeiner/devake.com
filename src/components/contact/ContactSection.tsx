    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto px-4 xl:px-0">
        ...
        <h2
          ref={headingRef}
          id="contact-heading"
          className="mt-xl text-[48px] sm:text-[56px] md:text-[80px] lg:text-[100px] font-medium tracking-[-3px] leading-[1.05] text-text-primary"
        >
          Let&rsquo;s Build Something.
        </h2>

        {/* Two-column layout */}
        <div className="mt-xl grid grid-cols-1 lg:grid-cols-2 gap-xl">
          {/* Left: contact info */}
          <div ref={leftColRef} className="flex flex-col gap-lg">
            ...
            <div className="flex flex-col gap-xs">
              <span className="text-[18px] text-text-primary/70">
